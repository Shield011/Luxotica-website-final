        ...
        <div>
            ...
            <div className='contact-navigation'>
                <div className="navigation-row">
                    ...
                    <a className="nav-text" href="/contact">Contact Us</a>
                </div>
                ...
                <div className='contact-us-information-section'>
                    <div className="contact-form-container">
                        ...
                        <span className='contact-form-info'>
                            Enter your queries here, and Luxotica will reach out as soon as possible.
                        </span>
                        <form className='contact-us-form'>
                            <input className = 'contact-form-input' type='text' required placeholder='Your Name' />
                            <input className = 'contact-form-input' type='text' required placeholder='Your Email Id' />
                            <input  className = 'contact-form-input' type='text' required placeholder='Phone Number' />
                            <textarea className = 'contact-form-input long' type='text' required placeholder='Type your queries here' />
                            <div className = 'form-submit-button'>
                                Submit
                                <FontAwesomeIcon icon = {faAngleRight} className ='form-submit-icon'/></div>
                        ...
                        <div className='contact-us-call-information'>
                            ...
                            <div className='calling-details'>
                                <div className='reach-us-details'>
                                    <FontAwesomeIcon icon={faLocationDot} className='contact-address-icon' />
                                    <span className="address">Address:</span>
                                    <p className='address-detail'>
                                        200A, 1, Shyama Prasad Mukherjee Rd,
                                        Mudiali, Lake Gardens, Kolkata, West Bengal 700026
                                    </p>


                                </div>
                                <div className='reach-us-details'>
                                    <FontAwesomeIcon icon={faPhone} className='contact-phone-icon' />
                                    <span className="phone">Phone:</span>
                                    <p className='phone-detail'>
                                        +91 98318 86240

                                    </p>
                                    <p className='phone-detail-2'>
                                        +91  9038603999
                                ...
                                <div className='reach-us-details'>
                                    <FontAwesomeIcon icon={faEnvelope} className='contact-mail-icon' />
